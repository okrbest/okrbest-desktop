...
const codeDefinitions = {
    ...
    __SKIP_ONBOARDING_SCREENS__: JSON.stringify(process.env.OKRBEST_DESKTOP_BUILD_SKIPONBOARDINGSCREENS === 'true'),
    __DISABLE_GPU__: JSON.stringify(process.env.OKRBEST_DESKTOP_BUILD_DISABLEGPU === 'true'),
    __SENTRY_DSN__: JSON.stringify(process.env.OKRBEST_DESKTOP_BUILD_SENTRYDSN || ''),
};
