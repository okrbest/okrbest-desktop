...
const buildConfig: BuildConfig = {
  ...
  */],
    ...
    macAppStoreUpdateURL: 'macappstore://apps.apple.com/us/app/okrbest-desktop/id1614666244',
    windowsStoreUpdateURL: 'ms-windows-store://pdp/?productid=XP8BR8MH3LPKLT',
    linuxUpdateURL: 'https://docs.okrbest.com/deployment-guide/desktop/linux-desktop-install.html',
    linuxGitHubReleaseURL: 'https://github.com/okrbest/okrbest-desktop/releases/tag/v',
